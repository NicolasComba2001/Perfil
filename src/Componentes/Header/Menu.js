      ...
      `}>
        ...
        >
          ...
          >
            ...
            <li className="m-2.5 text-center lg:mr-8">
              <Link to="contacto" smooth={true}  duration={1000} activeClass={'shadow-inner shadow-black transition-transform md:before:scale-x-100 md:after:scale-x-100 lg:before:scale-x-100 2xl:before:scale-x-100'} spy={true} className="cursor-pointer text-neutral-50
              text-[2em]
              after:content-['']
              after:absolute
              after:left-0
