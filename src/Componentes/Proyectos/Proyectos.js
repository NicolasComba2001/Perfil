  ...
  return (
    <article id="proyectos" className="mt-12 lg:mt-24">
      <section className="w-full">
        ...
        2xl:text-[1.3em]
        ">
          Los proyectos son una muestra gráfica y practica de todo lo que los desarrolladores, pueden mostrar en diferentes formas y estilos.
        </p>
      </section>
      <article className="mt-8 mb-8 w-full flex flex-col justify-center items-center">
          ...
          >Proyectos con: {} </p>
          <input type="text" placeholder="Tecnologia a buscar; Tailwind, React, Next"
          className="
            outline-transparent
            text-[1.2em]
            p-2
